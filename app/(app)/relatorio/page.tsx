 ...
 *
 *   POST /processos/:numero/relatorio/advogado · GET /processos/relatorio/:id · POST /processos/relatorio/:id/aprovar
 *
...
const ROTAS = 'POST /processos/:numero/relatorio/advogado · GET /processos/relatorio/:id · POST /processos/relatorio/:id/aprovar';
