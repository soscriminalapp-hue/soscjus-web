 ...
 *
 *   GET /honorarios/charges · POST /honorarios/charges  {method: PIX | BOLETO | AMBOS} · GET/PUT /honorarios/bank-account
 *
...
const ROTAS = 'GET /honorarios/charges · POST /honorarios/charges  {method: PIX | BOLETO | AMBOS} · GET/PUT /honorarios/bank-account';
  ...
  return (
    <>
      <Cabecalho
        ...
        destaque="Honorários"
        tom="money"
        texto="Cobre por PIX ou anexe o boleto do seu banco. O dinheiro vai direto pra sua conta."
      />

      <div className="card">
        <div className={'card-b'} style={CAIXA}>
          <div style={{ color: 'var(--money)', marginBottom: 20 }}>
            <Icon n="dinheiro" s={44} />
          </div>
