 ...
 *
 *   GET /lawyers/me · PUT /lawyers/me/logo · PUT /lawyers/me/office-name · GET/PUT /honorarios/bank-account
 *
...
const ROTAS = 'GET /lawyers/me · PUT /lawyers/me/logo · PUT /lawyers/me/office-name · GET/PUT /honorarios/bank-account';
  ...
  return (
    <>
      <Cabecalho
        ...
        destaque="Escritório"
        tom="gold"
        texto="Logomarca, chave PIX e carteira da OAB. Configure uma vez e não mexe mais."
      />
