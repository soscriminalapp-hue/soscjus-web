 ...
 *
 *   GET /api/juriscreator/config · GET /api/juriscreator/topics · GET /api/juriscreator/credito · POST /api/juriscreator/generate
 *
...
const ROTAS = 'GET /api/juriscreator/config · GET /api/juriscreator/topics · GET /api/juriscreator/credito · POST /api/juriscreator/generate';
  ...
  return (
    <>
      <Cabecalho
        ...
        destaque="Creator"
        tom="mind"
        texto="Pesquise a jurisprudência sobre a tese. Ele acha a decisão e monta o post pronto para publicar."
      />

      <div className="card">
        <div className={'card-b'} style={CAIXA}>
          <div style={{ color: 'var(--mind)', marginBottom: 20 }}>
            <Icon n="ia" s={44} />
          </div>
